...
int filterAngs[sensorCount] = {3, 5, 5};
float angW = 0.5;
float readW = 0.5;
//MPU:
MPU6050 mpu;
...
int readFromMPU(int sensorIndex){
  switch(sensorIndex){
    ...
    return 90;
    }if((90 - ((ypr[0] * 180/M_PI) - secound_servo_starting_angle)) < 0){
        return 0;
        }
        if((90 - ((ypr[0] * 180/M_PI) - secound_servo_starting_angle)) > 180){
          return 180;
          
          }
      return 90 - ((ypr[0] * 180/M_PI) - secound_servo_starting_angle) ;
...
//      if(180 - ((ypr[1] * 180/M_PI) - third_servo_starting_angle)+90 < 0){
      if((90  - ((ypr[1] * 180/M_PI) - third_servo_starting_angle)) < 0){

        return 0;
        }
//        if(180 - ((ypr[1] * 180/M_PI) - third_servo_starting_angle)+90 > 180){
        if((90 - ((ypr[1] * 180/M_PI) - third_servo_starting_angle) )> 180){

          return 180;
          
          }
  //    return (int)(180-((ypr[1] * 180/M_PI) - third_servo_starting_angle)+90)%180;
      return (90 - ((ypr[1] * 180/M_PI) - third_servo_starting_angle));
